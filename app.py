...
def get_price(company,start,end):
    ...
    return render_template('index.html', cc=cc, cn=cn, sec=sec,markc=markc,c1=c1, c2=c2, c3=c3,
                           cm1=cm1, cm2=cm2, cm3=cm3, comparison = comparison, numdays = numdays, late=late, qu=qu, articles=articles)
